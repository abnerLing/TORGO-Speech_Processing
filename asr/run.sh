...
home_dir=/home/abner/kaldi/egs/torgo/asr #adjust to your directory
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    echo "Iteration 1 word-error rate"
    cat exp/tri4/graph exp/dnn4b_pretrain-dbn_dnn_smbr/decode_it1/scoring_kaldi/best_wer
    echo "Iteration 3 word-error rate"
    cat exp/tri4/graph exp/dnn4b_pretrain-dbn_dnn_smbr/decode_it3/scoring_kaldi/best_wer
    echo "Iteration 5 word-error rate"
    cat exp/tri4/graph exp/dnn4b_pretrain-dbn_dnn_smbr/decode_it5/scoring_kaldi/best_wer
fi
